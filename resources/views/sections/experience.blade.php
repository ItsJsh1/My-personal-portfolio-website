...
<section id="experience" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="relative">
                    ...
                    <div class="relative mb-12 group">
                        <div class="flex flex-col md:flex-row items-start">
                            ...
                            <!-- Content Card -->
                            <div class="ml-10 md:ml-0 md:w-1/2 md:pr-12 md:text-right scroll-reveal-left">
                                <div class="bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-xl shadow-md border-2 border-dashed border-yellow-300 hover:border-accent transition-all duration-300 transform hover:-translate-y-1">
                                    ...
                                    <a href="#contact" class="inline-flex items-center gap-2 mt-4 text-accent hover:text-primary font-medium text-sm transition-colors md:justify-end nav-link">
                                        Let's Connect
                    ...
                    <div class="relative mb-12 group">
                        <div class="flex flex-col md:flex-row items-start">
                            ...
                            <!-- Content Card -->
                            <div class="ml-10 md:ml-0 md:w-1/2 md:pl-12 md:ml-auto scroll-reveal-right delay-100">
                    ...
                    <div class="relative mb-12 group">
                        <div class="flex flex-col md:flex-row items-start">
                            ...
                            <!-- Content Card -->
                            <div class="ml-10 md:ml-0 md:w-1/2 md:pr-12 md:text-right scroll-reveal-left delay-200">
                    ...
                    <div class="relative mb-12 group">
                        <div class="flex flex-col md:flex-row items-start">
                            ...
                            <!-- Content Card -->
                            <div class="ml-10 md:ml-0 md:w-1/2 md:pl-12 md:ml-auto scroll-reveal-right delay-300">
                                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-l-4 border-primary">
                                    <div class="flex items-center gap-2 mb-3">
                                        <span class="bg-accent/10 text-accent text-xs font-semibold px-3 py-1 rounded-full">Ended</span>
                                    </div>
        ...
        <div class="mb-20">
            <h3 class="text-2xl font-bold text-primary text-center mb-10 scroll-reveal">What I Bring to the Table</h3>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group scroll-reveal-scale delay-100">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group scroll-reveal-scale delay-200">
                    <div class="w-14 h-14 bg-accent/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-accent group-hover:scale-110 transition-all duration-300">
                        <svg class="w-7 h-7 text-accent group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group scroll-reveal-scale delay-300">
                    <div class="w-14 h-14 bg-accent/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-accent group-hover:scale-110 transition-all duration-300">
                        <svg class="w-7 h-7 text-accent group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group scroll-reveal-scale delay-400">
                    <div class="w-14 h-14 bg-accent/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-accent group-hover:scale-110 transition-all duration-300">
                        <svg class="w-7 h-7 text-accent group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- CTA Section -->
        <div class="text-center scroll-reveal-scale">
            <div class="bg-gradient-to-r from-accent to-secondary rounded-2xl p-10 text-white">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="#contact" class="email-btn-animated inline-flex items-center justify-center gap-2 bg-white text-primary px-6 py-3 rounded-lg font-semibold hover:bg-accent hover:text-white transition-all duration-300 nav-link relative overflow-hidden">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        Get in Touch
                    </a>
                    <a href="#cv" class="inline-flex items-center justify-center gap-2 bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-primary transition-all duration-300 transform hover:scale-105 nav-link">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
