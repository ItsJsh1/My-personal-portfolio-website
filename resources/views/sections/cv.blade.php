<!-- CV Section -->
<section id="cv" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <!-- CV Preview Card -->
        <div class="mb-12 scroll-reveal-scale delay-100">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        @if(file_exists(public_path('documents/cv.pdf')))
                            ...
                            >
                                ...
                                <span class="text-center">Download My Professional Photo</span>
                            </a>
                        @else
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 text-center scroll-reveal-scale delay-100">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 text-center scroll-reveal-scale delay-200">
                <div class="w-14 h-14 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-7 h-7 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 text-center scroll-reveal-scale delay-300">
                <div class="w-14 h-14 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-7 h-7 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
