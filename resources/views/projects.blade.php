...
<div class="max-w-7xl mx-auto px-4 py-20">
    <h2 class="text-4xl font-bold text-primary mb-4">My<span class="text-accent"> Projects</span></h2>
    <p class="text-gray-600 mb-12">A showcase of my recent work and personal projects</p>
